 ...
 * @describe：自定义相机View
 * @deprecated 暂不使用 androidX功能无法使用 lyf
 */
...
//    private android.support.camera.view.CameraView mCameraView;
...
//                mCameraView.setCaptureMode(android.support.camera.view.CameraView.CaptureMode.IMAGE);
...
//                                mImagePreview, mCaptureLayout, mImageCallbackListener, mCameraListener));
            ...
            public void recordStart() {
                mSwitchCamera.setVisibility(INVISIBLE);
                mFlashLamp.setVisibility(INVISIBLE);
//                mCameraView.setCaptureMode(android.support.camera.view.CameraView.CaptureMode.VIDEO);
...
//                mCameraView.stopRecording();
        ...
        mCaptureLayout.setTypeListener(new TypeListener() {
            ...
            @Override
            public void confirm() {
//                if (mCameraView.getCaptureMode() == android.support.camera.view.CameraView.CaptureMode.VIDEO) {
//                    if (mVideoFile == null) {
//                        return;
//                    }
//                    stopVideoPlay();
