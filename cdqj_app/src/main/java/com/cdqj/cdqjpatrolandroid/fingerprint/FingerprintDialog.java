...
public class FingerprintDialog extends DialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        setCancelable(false);
        View view = inflater.inflate(R.layout.cdqj_patrol_biometricprompt_layout_fingerprint_dialog, container);
    ...
    public FingerprintDialog setActionListener(FingerprintDialog.OnDialogActionListener actionListener) {
