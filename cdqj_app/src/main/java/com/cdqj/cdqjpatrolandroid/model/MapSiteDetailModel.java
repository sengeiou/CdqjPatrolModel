 ...
 * desc：地图工地详情M
 */
public class MapSiteDetailModel extends BaseModel {
    /**
     * 回调
     */
    private PatrolOnListener mOnListener;

    public MapSiteDetailModel(PatrolOnListener mOnListener) {
     ...
     * @return Subscription
     */
    public BaseSubscriber getMapSiteDetail(boolean flag) {
        return new BaseSubscriber<BasePostResponse<List<List<OrderSuperviseReportBean>>>>() {
                    ...
                    public void onResult(BasePostResponse<List<List<OrderSuperviseReportBean>>> bean) {
                        mOnListener.onGetMapSiteDetailSuccess(bean, flag);
                    }
    ...
    public interface PatrolOnListener {
         ...
         * @param flag 是否是刷新
         */
        void onGetMapSiteDetailSuccess(BasePostResponse<List<List<OrderSuperviseReportBean>>> body, boolean flag);
    }
}
