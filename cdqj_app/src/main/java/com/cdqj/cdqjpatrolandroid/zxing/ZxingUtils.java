package com.cdqj.cdqjpatrolandroid.zxing;
...
public class ZxingUtils {
     ...
     * @return BitMap
     *
     * 使用：createQRCodeBitmap(content, 800, 800,"UTF-8","H", "1", Color.BLACK, Color.WHITE);
     ...
     * @return Bitmap
     * 使用： createQRCodeBitmap(content, 800, 800,"UTF-8","H", "1", Color.BLACK, Color.WHITE,logoBitmap,0.2F);
