package com.cdqj.cdqjpatrolandroid.image.select;
...
import com.cdqj.cdqjpatrolandroid.image.listener.OnItemLongClickListener;
...
public class GridImageAdapter extends RecyclerView.Adapter<GridImageAdapter.ViewHolder> {
    ...
    public GridImageAdapter(Context context, OnAddPicClickListener mOnAddPicClickListener, int tag) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.cdqj_patrol_gv_filter_image, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            viewHolder.mImg.setImageResource(R.mipmap.icon_picture_add);
            viewHolder.mImg.setOnClickListener(v -> mOnAddPicClickListener.onAddPicClick(tag));
