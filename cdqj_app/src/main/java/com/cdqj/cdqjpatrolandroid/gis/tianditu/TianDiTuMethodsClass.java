...
/**
 * Created by lyf on 2018/9/12 16:18
 *
 * @author lyf
 * desc：天地图
 */
public class TianDiTuMethodsClass {
    ...
    private static final String URL_VECTOR_2000 = "http://{subDomain}.tianditu.com/DataServer?T=vec_c&x={col}&y={row}&l={level}&tk=" + Constant.TDT_KEY;
    private static final String URL_VECTOR_ANNOTATION_CHINESE_2000 = "http://{subDomain}.tianditu.com/DataServer?T=cva_c&x={col}&y={row}&l={level}&tk=" + Constant.TDT_KEY;
    private static final String URL_VECTOR_ANNOTATION_ENGLISH_2000 = "http://{subDomain}.tianditu.com/DataServer?T=eva_c&x={col}&y={row}&l={level}&tk=" + Constant.TDT_KEY;
    private static final String URL_IMAGE_2000 = "http://{subDomain}.tianditu.com/DataServer?T=img_c&x={col}&y={row}&l={level}&tk=" + Constant.TDT_KEY;
    private static final String URL_IMAGE_ANNOTATION_CHINESE_2000 = "http://{subDomain}.tianditu.com/DataServer?T=cia_c&x={col}&y={row}&l={level}&tk=" + Constant.TDT_KEY;
    private static final String URL_IMAGE_ANNOTATION_ENGLISH_2000 = "http://{subDomain}.tianditu.com/DataServer?T=eia_c&x={col}&y={row}&l={level}&tk=" + Constant.TDT_KEY;
    private static final String URL_TERRAIN_2000 = "http://{subDomain}.tianditu.com/DataServer?T=ter_c&x={col}&y={row}&l={level}&tk=" + Constant.TDT_KEY;
    private static final String URL_TERRAIN_ANNOTATION_CHINESE_2000 = "http://{subDomain}.tianditu.com/DataServer?T=cta_c&x={col}&y={row}&l={level}&tk=" + Constant.TDT_KEY;

    private static final String URL_VECTOR_MERCATOR = "http://{subDomain}.tianditu.com/DataServer?T=vec_w&x={col}&y={row}&l={level}&tk=" + Constant.TDT_KEY;
    private static final String URL_VECTOR_ANNOTATION_CHINESE_MERCATOR = "http://{subDomain}.tianditu.com/DataServer?T=cva_w&x={col}&y={row}&l={level}&tk=" + Constant.TDT_KEY;
    private static final String URL_VECTOR_ANNOTATION_ENGLISH_MERCATOR = "http://{subDomain}.tianditu.com/DataServer?T=eva_w&x={col}&y={row}&l={level}&tk=" + Constant.TDT_KEY;
    private static final String URL_IMAGE_MERCATOR = "http://{subDomain}.tianditu.com/DataServer?T=img_w&x={col}&y={row}&l={level}&tk=" + Constant.TDT_KEY;
    private static final String URL_IMAGE_ANNOTATION_CHINESE_MERCATOR = "http://{subDomain}.tianditu.com/DataServer?T=cia_w&x={col}&y={row}&l={level}&tk=" + Constant.TDT_KEY;
    private static final String URL_IMAGE_ANNOTATION_ENGLISH_MERCATOR = "http://{subDomain}.tianditu.com/DataServer?T=eia_w&x={col}&y={row}&l={level}&tk=" + Constant.TDT_KEY;
    private static final String URL_TERRAIN_MERCATOR = "http://{subDomain}.tianditu.com/DataServer?T=ter_w&x={col}&y={row}&l={level}&tk=" + Constant.TDT_KEY;
    private static final String URL_TERRAIN_ANNOTATION_CHINESE_MERCATOR = "http://{subDomain}.tianditu.com/DataServer?T=cta_w&x={col}&y={row}&l={level}&tk=" + Constant.TDT_KEY;
     ...
     * 4490 -2000坐标系
     */
    private static final SpatialReference SRID_2000 = SpatialReference.create(Constant.SRID_2000);
    ...
    public static WebTiledLayer createTianDiTuTiledLayer(TDTLayerType layerType) {
    ...
    private static TDTLayerType getTianDiTuLayerType(String layerType) {
        TDTLayerType result = TDTLayerType.TIANDITU_VECTOR_2000;
        switch (layerType) {
            /**
             * 天地图矢量墨卡托投影地图服务
             */
            case "TIANDITU_VECTOR_MERCATOR":
                result = TDTLayerType.TIANDITU_VECTOR_MERCATOR;
                break;
            /**
             * 天地图矢量墨卡托中文标注
             */
            case "TIANDITU_VECTOR_ANNOTATION_CHINESE_MERCATOR":
                result = TDTLayerType.TIANDITU_VECTOR_ANNOTATION_CHINESE_MERCATOR;
                break;
            /**
             * 天地图矢量墨卡托英文标注
             */
            case "TIANDITU_VECTOR_ANNOTATION_ENGLISH_MERCATOR":
                result = TDTLayerType.TIANDITU_VECTOR_ANNOTATION_ENGLISH_MERCATOR;
                break;
            /**
             * 天地图影像墨卡托投影地图服务
             */
            case "TIANDITU_IMAGE_MERCATOR":
                result = TDTLayerType.TIANDITU_IMAGE_MERCATOR;
                break;
            /**
             * 天地图影像墨卡托投影中文标注
             */
            case "TIANDITU_IMAGE_ANNOTATION_CHINESE_MERCATOR":
                result = TDTLayerType.TIANDITU_IMAGE_ANNOTATION_CHINESE_MERCATOR;
                break;
            /**
             * 天地图影像墨卡托投影英文标注
             */
            case "TIANDITU_IMAGE_ANNOTATION_ENGLISH_MERCATOR":
                result = TDTLayerType.TIANDITU_IMAGE_ANNOTATION_ENGLISH_MERCATOR;
                break;
            /**
             * 天地图地形墨卡托投影地图服务
             */
            case "TIANDITU_TERRAIN_MERCATOR":
                result = TDTLayerType.TIANDITU_TERRAIN_MERCATOR;
                break;
            /**
             * 天地图地形墨卡托投影中文标注
             */
            case "TIANDITU_TERRAIN_ANNOTATION_CHINESE_MERCATOR":
                result = TDTLayerType.TIANDITU_TERRAIN_ANNOTATION_CHINESE_MERCATOR;
                break;
            /**
             * 天地图矢量国家2000坐标系地图服务
             */
            case "TIANDITU_VECTOR_2000":
                result = TDTLayerType.TIANDITU_VECTOR_2000;
                break;
            /**
             * 天地图矢量国家2000坐标系中文标注
             */
            case "TIANDITU_VECTOR_ANNOTATION_CHINESE_2000":
                result = TDTLayerType.TIANDITU_VECTOR_ANNOTATION_CHINESE_2000;
                break;
            /**
             * 天地图矢量国家2000坐标系英文标注
             */
            case "TIANDITU_VECTOR_ANNOTATION_ENGLISH_2000":
                result = TDTLayerType.TIANDITU_VECTOR_ANNOTATION_ENGLISH_2000;
                break;
            /**
             * 天地图影像国家2000坐标系地图服务
             */
            case "TIANDITU_IMAGE_2000":
                result = TDTLayerType.TIANDITU_IMAGE_2000;
                break;
            /**
             * 天地图影像国家2000坐标系中文标注
             */
            case "TIANDITU_IMAGE_ANNOTATION_CHINESE_2000":
                result = TDTLayerType.TIANDITU_IMAGE_ANNOTATION_CHINESE_2000;
                break;
            /**
             * 天地图影像国家2000坐标系英文标注
             */
            case "TIANDITU_IMAGE_ANNOTATION_ENGLISH_2000":
                result = TDTLayerType.TIANDITU_IMAGE_ANNOTATION_ENGLISH_2000;
                break;
            /**
             * 天地图地形国家2000坐标系地图服务
             */
            case "TIANDITU_TERRAIN_2000":
                result = TDTLayerType.TIANDITU_TERRAIN_2000;
                break;
            /**
             * 天地图地形国家2000坐标系中文标注
             */
            case "TIANDITU_TERRAIN_ANNOTATION_CHINESE_2000":
                result = TDTLayerType.TIANDITU_TERRAIN_ANNOTATION_CHINESE_2000;
                break;
                default:break;
        }
        return result;
