package com.cdqj.cdqjpatrolandroid.comstomview.view;
...
import com.cdqj.cdqjpatrolandroid.comstomview.view.content.ContentScrollView;
...
public class ScrollLayout extends FrameLayout {
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        ...
        if (a.hasValue(R.styleable.ScrollLayout_sl_mode)) {
            int mode = a.getInteger(R.styleable.ScrollLayout_sl_mode, 0);
            switch (mode) {
                case 0x0:
                    setToOpen();
                    break;
