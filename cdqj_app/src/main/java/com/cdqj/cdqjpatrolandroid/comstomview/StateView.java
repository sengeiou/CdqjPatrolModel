...
import com.cdqj.cdqjpatrolandroid.listener.AnimatorProvider;
...
public class StateView extends View {
    ...
    public StateView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (mEmptyResource == 0) {
            mEmptyResource = R.layout.cdqj_patrol_base_empty;
        }
        if (mRetryResource == 0) {
            mRetryResource = R.layout.cdqj_patrol_base_retry;
        }
        if (mLoadingResource == 0) {
            mLoadingResource = R.layout.cdqj_patrol_base_loading;
        }
