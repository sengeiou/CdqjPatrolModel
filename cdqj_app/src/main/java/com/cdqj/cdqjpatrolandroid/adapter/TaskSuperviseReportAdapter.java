 ...
 * desc：任务上报文件Adapter
 */
public class TaskSuperviseReportAdapter extends BaseQuickAdapter<PlanSuperviseReportBean, PatrolViewHolder> {

    private Context mContext;
    private ArrayList<ImageViewBean> mThumbViewInfoList;
    private PatrolTaskResultBean bean;

    public TaskSuperviseReportAdapter(int layoutResId, @Nullable List<PlanSuperviseReportBean> data, Context context, PatrolTaskResultBean bean) {
        super(layoutResId, data);
        this.mContext = context;
        this.bean = ObjectUtils.isEmpty(bean)?new PatrolTaskResultBean():bean;
    }

    @Override
    protected void convert(PatrolViewHolder helper, final PlanSuperviseReportBean item) {
        ...
        helper.setText(R.id.supervise_report_type, StringUtils.isTrimEmpty(bean.getCheckName())?
                mContext.getString(R.string.null_text):bean.getCheckName());
