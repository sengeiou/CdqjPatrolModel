...
public class TrafficUtils {
    ...
    private static final String LOG_TAG = "TrafficUtils";
    ...
    public TrafficUtils(Context mContext, Handler mHandler, int uid) {
        ...
        TrafficUtils.uid = uid;
    }

    public TrafficUtils(Context mContext, Handler mHandler) {
        this.mContext = mContext;
        this.mHandler = mHandler;
        TrafficUtils.uid = getUid();
    }

    public static TrafficUtils getInstant(Context mContext, Handler mHandler) {
        if (instance == null) {
    ...
    public long getRcvTraffic() {
        ...
        LogUtils.i(LOG_TAG, rcvTraffic + "--1");
        ...
        try {
            ...
            LogUtils.e(LOG_TAG, "FileNotFoundException: " + e.getMessage());
